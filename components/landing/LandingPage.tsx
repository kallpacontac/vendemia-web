...
import Hero from './HeroDemo';
import './ambient.css';
import Benefit from '@/components/sections/Benefit';
import BentoA from '@/components/sections/BentoA';
import ChatDemo from './InteractiveChatDemo';
import UseCases from './UseCasesDemo';
 ...
 */
export default function LandingPage({ startPath = '/empezar' }: { startPath?: string }) {
  ...
  return (
    <>
      ...
      <Footer wordmark={<Wordmark />} socialLogos={<SocialLogos />} hidePaymentAssets compactBottom />
    </>
  );
}
