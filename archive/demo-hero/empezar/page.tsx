...
export const metadata: Metadata = { title: 'Mia para tu negocio | Vendemia' };

export default function StartPage({ searchParams }: { searchParams: { plan?: string; moneda?: string } }) {
  return <BrandSurface><PlanJourney initialPlan={resolvePlan(searchParams.plan)} initialCurrency={searchParams.moneda === 'USD' ? 1 : 0} homePath="/demo-hero" /></BrandSurface>;
}
